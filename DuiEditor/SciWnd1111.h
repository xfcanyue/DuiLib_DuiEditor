...
public:
	...
	//清空文档所有字符
	SciDll_void sci_ClearTextAll() {return 0; }
	//获取所有字符
...
//清空文档所有字符
inline SciDll_void CSciWnd::ClearTextAll()
{
...
{
	return 0; //return execute(SCI_SETSTYLEBITS,bits,0);
}

//获取字符字体风格
inline int CSciWnd::sci_GetStyleBits()
{
	return 0; //return execute(SCI_GETSTYLEBITS,0,0);	
}
...
{
	return 0; //return execute(SCI_SETTWOPHASEDRAW,twoPhase,0);
}

inline BOOL CSciWnd::sci_GetTwoPhaseDraw()
{
	return 0; //return execute(SCI_GETTWOPHASEDRAW);
}
...
{
	return 0; //return execute(SCI_GETSTYLEBITSNEEDED);
}
