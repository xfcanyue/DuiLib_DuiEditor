#ifndef __UIMENU_WND_WIN32_H__
#define __UIMENU_WND_WIN32_H__
...
//
//
class UILIB_API CMenuWndWin32 : public CWindowWnd, public MenuReceiverImpl, public INotifyUI, public IDialogBuilderCallback
{
public:
