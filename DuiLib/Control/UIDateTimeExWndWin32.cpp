...
CDateTimeExWndWin32::CDateTimeExWndWin32() : m_pOwner(NULL), m_hBkBrush(NULL), m_bInit(false), m_bDropOpen(false), m_uFormatStyle(UIDTS_DATE)
{
}

CDateTimeExWndWin32::~CDateTimeExWndWin32()
{
}

void CDateTimeExWndWin32::Init(CDateTimeExUI* pOwner, UINT uFormatStyle)
{
	m_pOwner = pOwner;
...
RECT CDateTimeExWndWin32::CalPos()
{
	CDuiRect rcPos;
...
LPCTSTR CDateTimeExWndWin32::GetWindowClassName() const
{
	return _T("DateTimeExWnd");
}

LPCTSTR CDateTimeExWndWin32::GetSuperClassName() const
{
	return DATETIMEPICK_CLASS;
}

void CDateTimeExWndWin32::OnFinalMessage(HWND hWnd)
{
...
LRESULT CDateTimeExWndWin32::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	LRESULT lRes = 0;
	BOOL bHandled = TRUE;
	if( uMsg == WM_CREATE ) {
