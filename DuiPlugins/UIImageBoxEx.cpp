...
{	
	if(m_idEventTimer != 0)
	{
		...
		g_MapTimerID_TO_CImageBoxExUI.RemoveKey((void *) m_idEventTimer);
		m_idEventTimer = 0;
	}
...
{
	CImageBoxExUI *pObject;
	if (g_MapTimerID_TO_CImageBoxExUI.Lookup((void *) idEvent, (void*&)pObject))
	{
...
void CImageBoxExUI::Play()
{
	...
	g_MapTimerID_TO_CImageBoxExUI.SetAt((void *) m_idEventTimer, this);
}
